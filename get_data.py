...
if os.path.exists(os.path.join('data', 'ut-zap50k-images')):
    ...
    urllib.urlretrieve("http://vision.cs.utexas.edu/projects/finegrained/utzap50k/ut-zap50k-images.zip", filename="data/ut-zap50k-imgs.zip")
...
if os.path.exists(os.path.join('data', 'tripletlists')):
    ...
    urllib.urlretrieve("https://s3.amazonaws.com/andreas-datasets/csn_zappos_triplets.zip", filename="data/triplets.zip")
